...
public class LocationAdapter  extends BaseMultiItemQuickAdapter<ChannelItem, BaseViewHolder> {
    ...
    public LocationAdapter(List<ChannelItem> data, ItemTouchHelper itemTouchHelper) {
        super(data);
