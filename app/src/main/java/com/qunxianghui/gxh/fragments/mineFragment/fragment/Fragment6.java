...
public class Fragment6 extends BaseFragment {
    ...
    PhotoView mIvMineAddFragment1BigAdver;
    @BindView(R.id.et_fragment_bigpic_link)
    EditText mEtFragmentBigpicLink;
    ...
    public void initViews(View view) {
        ...
        if (isComingFromColum) {
            ...
            GlideApp.with(mActivity)
                    ...
                    .into(mIvMineAddFragment1BigAdver);
            mEtFragmentBigpicLink.setText(intent.getStringExtra("link"));
        }
