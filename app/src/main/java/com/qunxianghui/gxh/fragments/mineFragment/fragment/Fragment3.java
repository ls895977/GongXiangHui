...
public class Fragment3 extends BaseFragment {
    ...
    public void initViews(View view) {
        ...
        if (isComingFromColum) {
            ...
            etMineLinkAddFragment3.setText(intent.getStringExtra("link"));
        }
        ...
        imagePicker.startChooser(this, new ImagePicker.Callback() {
            ...
            public void cropConfig(CropImage.ActivityBuilder builder) {
                builder
                        ...
                        .setMinCropWindowSize(DisplayUtil.dip2px(mActivity, 345), DisplayUtil.dip2px(mActivity, 90))
                        .setRequestedSize(DisplayUtil.dip2px(mActivity, 345), DisplayUtil.dip2px(mActivity, 90))
                        .setAspectRatio(2, 1);
            }
    ...
    @OnClick(R.id.iv_mine_addColumns_Adver_three)
