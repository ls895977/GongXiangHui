...
public class BaoliaoDetailAdapter extends BaseRecycleViewAdapter<BaoliaoBean.DataBean.Content> {

    public boolean isShow = false;

    public BaoliaoDetailAdapter(Context context, List<BaoliaoBean.DataBean.Content> datas) {
        super(context, datas);
    }

    @Override
    protected void convert(MyViewHolder holder, int position, final BaoliaoBean.DataBean.Content dataBean) {
