...
public class ImagePicker2Adapter extends RecyclerView.Adapter<ImagePicker2Adapter.SelectedPicViewHolder> {
    ...
    public ImagePicker2Adapter(Context mContext, List<ImageItem> data, int maxImgCount) {
    ...
    public class SelectedPicViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void bind(int position) {
            ...
            if (isAdded && position == getItemCount() - 1) {
                iv_img.setImageResource(R.mipmap.icon_question_post_img);
