package com.qunxianghui.gxh.widget.video2pic;
 ...
 * data：16/7/27
 */
public class GridImageSelfAdapter extends
        RecyclerView.Adapter<GridImageSelfAdapter.ViewHolder> {
    ...
    public GridImageSelfAdapter(Context context, onAddPicClickListener mOnAddPicClickListener) {
