...
public class HomeAirActivity extends BaseActivity implements AdapterView.OnItemClickListener {
    ...
    private HomeChannelAdapter mUserAdapter;
    private HomeChannelAdapter mOtherAdapter;
    ...
    protected void initViews() {
        ...
        mOtherAdapter = new HomeChannelAdapter(this, mOtherList, true);
                        ...
                        new android.os.Handler().postDelayed(new Runnable() {
                            ...
                            public void run() {
                                try {
                                    ...
                                    MoveAnim(moveImageView, startLocation, endLocation, channel, mOtherGv, true);
    ...
    private void MoveAnim(View moveView, int[] startLocation, int[] endLocation, final String moveChannel, final MyGridView clickGridView, final boolean isUser) {
